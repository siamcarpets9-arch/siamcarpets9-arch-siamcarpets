...
const seedDesignsReal = [
  ...
  {id:"MO-0147-26",project:"VILLA 1063",customer:"ROLLS SUPPLY W.L.L.",scope:"-",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0147/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ขอส่ง  25/9",sample:false},
  ...
  {id:"MO-0149-26",project:"NIGERIA",customer:"INTERSPAZIO S.R.L.",scope:"-",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0149/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทันขอเลื่อน 25/9",sample:false},
  ...
  {id:"MO-0151-26",project:"PO.BRI500037 WESTIN HILTON HEAD",customer:"BRINTONS - USA.",scope:"-",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0151/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-0155-26",project:"SHEIKHA DEEMA AL MANA",customer:"GALLERY FRANCAIS",scope:"-",due:"2 ต.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0155/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"weaving",weaveLocation:"SIAM",sample:false},
  {id:"MO-0156-26",project:"SC#2553",customer:"INNOVATIVE CARPETS",scope:"-",due:"2 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0156/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",sample:false},
  {id:"MO-0157-26",project:"SC#2554",customer:"INNOVATIVE CARPETS",scope:"-",due:"14 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0157/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",sample:false},
  {id:"MO-0158-26",project:"SC#2555(A)",customer:"INNOVATIVE",scope:"-",due:"7 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0158/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"เลื่อนไม่ได้",sample:false},
  {id:"MO-0159-26",project:"SC#2555(B)",customer:"INNOVATIVE",scope:"-",due:"7 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0159/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"เลื่อนไม่ได้",sample:false},
  {id:"MO-0160-26",project:"SC#2556(A)",customer:"INNOVATIVE CARPETS",scope:"-",due:"30 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0160/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",sample:false},
  {id:"MO-0161-26",project:"SC#2556(B)",customer:"INNOVATIVE CARPETS",scope:"HWO-450 CUT & LOW TIGHT LOOP WITH 25% T/S, แต่งเรียบ/พับขอบ",due:"30 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0161/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0162-26",project:"SC#2556(C)",customer:"INNOVATIVE CARPETS",scope:"-",due:"30 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0162/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"เดมา",sample:false},
  {id:"MO-0164-26",project:"SC#2556(E)",customer:"INNOVATIVE CARPETS",scope:"-",due:"30 ต.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0164/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"weaving",weaveLocation:"SIAM",sample:false},
  {id:"MO-0165-26",project:"SC#2552(A)",customer:"INNOVATIVE CARPETS",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0165/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ส่งได้ 9/10 ห้ามเลื่อนอีก",sample:false},
  {id:"MO-0166-26",project:"SC#2552(B)",customer:"INNOVATIVE CARPETS",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0166/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ส่งได้ 9/10 ห้ามเลื่อนอีก",sample:false},
  {id:"MO-0167-26",project:"SC#2552(C)",customer:"INNOVATIVE CARPETS",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0167/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ส่งได้ 9/10 ห้ามเลื่อนอีก",sample:false},
  {id:"MO-0168-26",project:"SC#2552(D)",customer:"INNOVATIVE CARPETS",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0168/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",sample:false},
  {id:"MO-0169-26",project:"PO.3315/26 THE HOUR GLASS-SIAM ICON",customer:"SCM.98",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0169/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0170-26",project:"PO.3315/26 THE HOUR GLASS-SIAM ICON",customer:"SCM.98",scope:"-",due:"9 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0170/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0171-26",project:"PO.101346 MAIN VILLA",customer:"AREEN DESIGN",scope:"HPA-450 CUT & LOOP WITH CARVING",due:"2 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0171/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ด่วน",sample:false},
  {id:"MO-0172-26",project:"RLS/287/26 ITALY NEW RUGS AN013",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT WITH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0172/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0173-26",project:"RLS/287/26 ITALY NEW RUGS AN013",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT WITH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0173/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0174-26",project:"RLS/287/26 ITALY NEW RUGS AN013",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT WITH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0174/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0175-26",project:"RLS/287/26 ITALY NEW RUGS AN013",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT WITH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0175/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0176-26",project:"RLS/286/26 TANUJA",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT WITH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0176/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0177-26",project:"CEO LIVING ROOM",customer:"GALLERY FRANCAIS",scope:"HWO-450 CUT WIYH CARVING",due:"6 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0177/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0178-26",project:"RLS/288/26 GCC26",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0178/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"แทรกด่วน",sample:false},
  {id:"MO-0179-26",project:"RLS/288/26 GCC26",customer:"ROLLS SUPPLY",scope:"HWO-450 CUT",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0179/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"แทรกด่วน",sample:false},
  {id:"MO-0180-26",project:"MADAM NOOR AL MAADEED",customer:"GALLERY FRANCAIS",scope:"HWO-450 CUT WITH CARVING",due:"13 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0180/26",market:"FOREIGN",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-TH 128-26 CC046-26",project:"PO#000914 D000700 Innovation",customer:"COLIN CAMPBELL",scope:"-",due:"18 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 128/26 CC046/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน  18/9",sample:false},
  ...
  {id:"MO-TH 140-26 CC048-26",project:"PO:0316  PROJECT:ZIG SKINK TUAPE",customer:"DILANA",scope:"-",due:"13 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 140/26 CC048/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-TH 146-26 CC053-26",project:"PO:#0011140-COLIN CAMPBELL PROJECT BLOOP MAROON",customer:"COLIN CAMPBELL",scope:"-",due:"19 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 146/26 CC053/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 147-26 CC054-26",project:"PO:#0011440-COLIN CAMPBELL PROJECT BLOOP OCHRE",customer:"COLIN CAMPBELL",scope:"-",due:"19 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 147/26 CC054/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 148-26 CC055-26",project:"PO:#001140-COLIN CAMPBELL PROJECT BLOOP DENIM",customer:"COLIN CAMPBELL",scope:"-",due:"19 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 148/26 CC055/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-TH 155-26",project:"TH 155/26",customer:"คุณนรเศรษฐ์ วรเศรษฐ์รักษา",scope:"-",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 155/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 159-26",project:"S 074/2569",customer:"บริษัท วีระศิลป์ดีไซน์ จำกัด",scope:"HPA-450CUT(PH=8MM.)",due:"30 ก.ย. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 159/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"weaving",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 161-26",project:"PO-D04-6909010 หน้าสาขา ร้าน Reunrom @ FL.G Siam Paragon",customer:"บริษัท คาร์มาร์ท จำกัด (มหาชน) สำนักงานใหญ่",scope:"-",due:"28 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 161/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",planNote:"ห้ามเลื่อน-ขอแทรก",sample:false},
  {id:"MO-TH 162-26",project:"S 051/2569 REV.3",customer:"บริษัท ไอ คอนโด ภูเก็ต จำกัด",scope:"HPRSK-450CUT(PH=7MM.)",due:"20 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 162/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 164-26",project:"S 089/2569",customer:"คุณคิว",scope:"HPA-450CUT(PH=8MM.)",due:"30 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 164/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 158-26",project:"S 056/2569 LITTLE BUNNY",customer:"บริษัท ลิตเติ้ลบันนี่ กรุ๊ป จำกัด",scope:"-",due:"20 ก.ย. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 158/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"weaving",weaveLocation:"SIAM",sample:false},
  {id:"MO-TH 157-26",project:"S054/2569",customer:"บริษัท แปซิฟิก รีเทล จำกัด",scope:"HPA45 LOOP (PH:7MM.)",due:"25 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 157/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-TH 160-26  CC057-26",project:"PO-0321",customer:"CACHET CARPETS / DILANA",scope:"-",due:"1 พ.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 160/26  CC057/26",market:"DOMESTIC",importSource:"QC Check Sheet",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  ...
  {id:"MO-TH 166-26",project:"S.063/2569 ",customer:"คุณสมศักดิ์ แสงแก้ว",scope:"-",due:"15 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 166/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",sample:false},
  {id:"MO-0123-26",project:"UMM FAHAD",customer:"GALLERY FRANCAIS",scope:"-",due:"4 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0123/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0125-26",project:"UMM FAHAD",customer:"GALLERY FRANCAIS",scope:"-",due:"4 ก.ย. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0125/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0126-26",project:"UMM FAHAD",customer:"GALLERY FRANCAIS",scope:"-",due:"4 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0126/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0127-26",project:"UMM FAHAD",customer:"GALLERY FRANCAIS",scope:"-",due:"4 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0127/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0128-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0128/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0130-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0130/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0131-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0131/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0134-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0134/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0135-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0135/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0136-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0136/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0138-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0138/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0139-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0139/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0140-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0140/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0141-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0141/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0142-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0142/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"SIAM",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0120-26",project:"UMM FAHAD",customer:"GALLERY FRANCAIS",scope:"-",due:"4 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0120/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0129-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0129/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0137-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0137/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0132-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0132/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0133-26",project:"SHEIKHA NOORA",customer:"GALLERY FRANCAIS",scope:"-",due:"11 ก.ย. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0133/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"คาร์เปทสตูดิโอ",planNote:"ไม่ทัน",sample:false},
  {id:"MO-0163-26",project:"SC#2556D",customer:"INNOVATIVE CARPETS",scope:"-",due:"30 ต.ค. 2026",progress:85,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"0163/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"finishing",weaveLocation:"เดมา",sample:false},
  {id:"MO-DM 007-26",project:"S.061/2569",customer:"บ.อัทยาภัณฑ์",scope:"-",due:"15 ก.ย. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"DM 007/26",market:"DOMESTIC",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"สจ.คาร์เปท",sample:false},
  {id:"MO-DM 008-26",project:"S.060/2569",customer:"บ.วี เดคคอร์",scope:"-",due:"27 ก.ย. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"DM 008/26",market:"DOMESTIC",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"สจ.คาร์เปท",sample:false},
  {id:"MO-TH 116-26",project:"MWM-RU-01 LIVING ROOM@เรข พัทยา-มอเตอร์เวย์",customer:"บ.เบทเทอร์ เฮาส์ซิ่ง 2022",scope:"-",due:"20 ส.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 116/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"SIAM",planNote:"แทรก ไม่ทันขอส่ง  20/8",sample:false},
  {id:"MO-TH 117-26",project:"MWM-RU-01 JETSKI ROOM@เรข พัทยา-มอเตอร์เวย์",customer:"บ.เบทเทอร์ เฮาส์ซิ่ง 2022",scope:"-",due:"20 ส.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 117/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"SIAM",planNote:"แทรก ไม่ทันขอส่ง  20/8",sample:false},
  {id:"MO-TH 118-26",project:"MWM-RU-01 WORKING ROOM@เรข พัทยา-มอเตอร์เวย์",customer:"บ.เบทเทอร์ เฮาส์ซิ่ง 2022",scope:"-",due:"15 ส.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 118/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"SIAM",planNote:"งานแทรก",sample:false},
  {id:"MO-TH 119-26",project:"MWM-RU-01 WORKING ROOM@เรข พัทยา-มอเตอร์เวย์",customer:"บ.เบทเทอร์ เฮาส์ซิ่ง 2022",scope:"-",due:"15 ส.ค. 2026",progress:65,status:"APPROVED",quote:"READY",owner:"",job:"OPENED",moNo:"TH 119/26",market:"FOREIGN",importSource:"MASTER PLAN 17-9-26",importStage:"weaving",weaveLocation:"SIAM",planNote:"งานแทรก",sample:false}
];
...
function deleteDesign(id){
  const row=designs.find((item)=>item.id===id);
  if(!row) return;
  if(!confirm(`ลบรายการ "${row.id} ${row.project||""}" ทิ้ง? (ลบแล้วกู้คืนไม่ได้)`)) return;
