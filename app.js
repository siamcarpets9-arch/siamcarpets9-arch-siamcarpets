...
function setView(view){
  ...
  const flowView=({cost:"design",salesreport:"sales",calc:"design",colors:"design",planwork:"planning",pattern:"planning",weaveissue:"planning",weavefloor:"planning",finishing:"planning",qcdash:"planning"})[view]||view; // หน้าต้นทุนอยู่ในขั้น Design · รายงานขายอยู่ในขั้น Sales · ใบวางแผนงาน/เจาะลาย/ส่งแผนกทอ/แผนกทอ/ทากาวตกแต่ง/QC อยู่ในขั้น Planning
